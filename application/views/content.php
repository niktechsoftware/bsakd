...
<div class="col-sm-3 notice" id="imp">
 ...
 <h3>सूचनापट </h3>
 <marquee id="marquee" scrollamount="2" direction="up" onMouseOver="this.stop();"  onmouseout="this.start();">
    <ul class="meeting text_color" >
                  <li>
    ...
    <ul class="meeting text_color" >
     ...
     <p class="e-pothi"><a href="https://basiceducationup.com/assets/EPothi.apk">DOWNLOAD E-POTHI</a></p>
</div>
...
<img src="<?php echo base_url()?>assets/images/photo%20of%20the%20day.jpg" class="img-responsive" id="img" width="300">
</p></a></div>
<div class="col-sm-6 img-thumbnail">
</a> <p style="font-size:18px; font-weight:700; text-align:center; color:#337ab7;">
    माह का वीडियो<iframe width="300" height="200" src="https://www.youtube.com/embed/lIgGIEMwaPo" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe></p>
 <p align="right"><a href="video-2.html">यहां अधिक देखें...</a></p>
</div>
</div>
</div>
<div class="col-sm-2 text-center notice">
  ...
  <ul class="important"  id="imp">
      ...
      <li><a href="http://www.scertup.co.in/" target="_blank"><i class="fa fa-angle-double-right"></i> राज्य शैक्षिक अनुसंधान एवं प्रशिक्षण परिषद् </a></li>
      <li><a href="http://student.udise.in/" target="_blank"><i class="fa fa-angle-double-right"></i> यू डायस डाटा</a></li>
      <li><a href="http://mhrd.gov.in/" target="_blank"><i class="fa fa-angle-double-right"></i> मानव संसाधन विकास मंत्रालय</a></li>
      <li><a href="http://mdm.nic.in/" target="_blank"><i class="fa fa-angle-double-right"></i> मिड डे मील </a></li>
      <li><a href="https://etender.up.nic.in/nicgep/app" target="_blank"><i class="fa fa-angle-double-right"></i> ई - निविदा</a></li>
      <li><a href="https://gem.gov.in/" target="_blank"><i class="fa fa-angle-double-right"></i> गवर्नमेंट ई-मार्केटिंग </a></li>
  </ul><br />
  </div>  </div>
</div>
<!===================================================Navachaar Section=====================================================>
<div class="container">
	<div class="row" style="background:rgba(0,0,0,0.7); ; color:#fff; padding:10px 10px">
    <h1 align="center" style="color:#fff">नवाचार  </h1><br />
    	<div class="col-sm-2 text-center">
        <img src="<?php echo base_url()?>assets/images/epathshala.png" width="130"><br />
		...
		एक संसृत रूपरेखा जिसका लक्ष्य है जांच और रचनात्मकता की भावना को पोषण करना, प्रेम करना।
        <a href="http://mhrd.gov.in/rashtriya-avishkar-abhiyan" target="_blank">आगे........</a></div>
    </div>
    <div class="row">
       <div class="col-sm-12 recent1" style="background:rgba(0,0,0,0.8); font-weight:700; font-size:18px ">
       <marquee  scrollamount="5" direction="left" onMouseOver="this.stop();"  onmouseout="this.start();">
        <img src="<?php echo base_url()?>assets/images/new.gif">
        <a href="#">नव प्रयोग सूक्ष्म नवाचारों की सन्दर्भ पुस्तिका </a> 
        </marquee>
        </div>
	</div>
</div>
<!===================================================Yojnayein=====================================================>
<div class="container">
	<div class="row" style="background:#fff; padding:10px 10px;">
    	<div class="col-sm-4"></div>
        <div class="col-sm-4"><h2  align="center">योजनाएं</h2></div>
        <div class="col-sm-4"></div>
    </div>
    <div class="row" style="background:#fff; padding:10px 10px;">
    	<div class="col-sm-3 text-center"><a href="http://upefa.com/upefaweb/" target="_blank">
