...
#footer { background:rgba(27,127,204,.8);}
#footer a{color:#fff}
...
<div class="container">
    ...
    <div class="col-sm-2 col-xs-offset-3">
      <a href="https://www.india.gov.in/" target="_blank">
        <img src="<?php echo base_url()?>assets/images/india_gob.jpg">
      </a>
    </div>
    <div class="col-sm-2">
      <a href="https://www.mygov.in/" target="_blank">
        <img src="<?php echo base_url()?>assets/images/img-mygov.jpg" >
      </a>
    </div>
    <div class="col-sm-2">
      <a href="http://goidirectory.nic.in/index.php" target="_blank">
        <img src="<?php echo base_url()?>assets/images/img-goi.jpg">
      </a>
    </div>
